...
class TestAlembicMigrationFramework:
    ...
    def test_alembic_current_and_history(self) -> None:
        ...
        assert "0004_source_snapshots" in current_res.stdout
    ...
    def test_alembic_downgrade_and_reupgrade_lifecycle(self) -> None:
        ...
        # Downgrade 1 step to 0003_source_registry
        ...
        assert "0004_source_snapshots" not in current_res.stdout
        ...
        assert "0004_source_snapshots" in current_restored.stdout
    ...
    def test_alembic_version_table_in_database(self) -> None:
        ...
        assert res.stdout.strip() == "0004_source_snapshots"
